...
const BenefitsSection: React.FC = () => {
  ...
  const benefits = [
    {
      icon: <ShieldCheck className="w-12 h-12 text-[#d7df21]" />,
      title: "Atendimento Sigiloso",
      description:
        "Sua privacidade é nossa prioridade absoluta. Todas as conversas são 100% confidenciais.",
    },
    {
      icon: <Package className="w-12 h-12 text-[#d7df21]" />,
      title: "Produtos Premium",
      description:
        "Curadoria exclusiva das melhores marcas nacionais e importadas.",
    },
    {
      icon: <Truck className="w-12 h-12 text-[#d7df21]" />,
      title: "Envio Discreto",
      description:
        "Embalagens neutras e sem identificação do conteúdo. Entrega para todo Brasil.",
    },
    {
      icon: <CreditCard className="w-12 h-12 text-[#d7df21]" />,
      title: "Facilidade no Pagamento",
      description:
        "Parcele em até 12x nos cartões. Pagamento seguro e facilitado.",
    },
  ];
    ...
    <section className="py-20 bg-neutral-900" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <span className="text-[#d7df21]">atendimento exclusivo</span>?
        </motion.h2>
