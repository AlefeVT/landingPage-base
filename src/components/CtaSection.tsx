  ...
  return (
    <section className="py-20 relative overflow-hidden" ref={ref}>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/6311607/pexels-photo-6311607.jpeg?auto=compress&cs=tinysrgb&w=1920')",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white leading-tight">
            Desperte sua <span className="text-[#d7df21]">sensualidade</span>{" "}
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-6">
              <ShieldCheck className="text-[#d7df21]" size={24} />
            ...
            <div className="flex items-center justify-center mb-6">
              <Clock className="text-[#d7df21] mr-2" size={20} />
            ...
            <motion.div
              ...
              className="flex items-center justify-center gap-2 text-pink-300 font-medium"
            >
